...
# Creating a function that calls the hangman class to play the game

def play_game(word_list):
    num_lives = 5
    game = Hangman(word_list, num_lives)

    # Creating a while loop that will ask user to input letter 

    while True:
        if game.num_lives == 0:
            print("You lost!")
            break # If the user has ran out of attemps and num_lives is equal to 0 they lose the game 
...
# Calls on the function so that the user can play the game 
